...
namespace tests
{
  public class Tests
  {
    ...
    {
      string input_a = "0.01000011000 * 2 ^-101";
      string input_b = "0.01000011000 * 2 ^-101";
      string expected = "\nC = 000110";

      string actual = Lab4.whatever(input_a, input_b);
    ...
    {
      string input_a = "0.01100011000 * 2^ 001";
      string input_b = "0.01010011000 * 2 ^-010";
      string expected = "\nC = 01011000101010";
